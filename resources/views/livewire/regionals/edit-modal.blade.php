<div>
    <button wire:click="$toggle('showModal')"
        class="px-5 py-2 font-bold hover:text-white text-[#375930] hover:bg-[#37593055] border border-[#37593055] rounded ">Editar</button>
    <x-modal wire:model='showModal' maxWidth="2xl">
        <div class="">
            <div class="px-5 py-3 border-b">
                <p class="text-base font-bold uppercase">Editar</p>
                <div class="flex">
                    <p class="text-lg font-bold">{{ $regional->identity }} - </p>
                    <p class="text-xl font-bold">{{ $regional->name }}</p>
                </div>
            </div>
            ...
            <div class="p-3 border-t">
                <div class="flex justify-end space-x-3">
                    ...
                    <button wire:click="updateRegional"
